...
> 最后更新：2026-09-14 23:59 UTC (M0-006 R2 PATCH COMPLETE)

## 里程碑总览

| 里程碑 | 目标 | 状态 | 完成度 |
|---|---|---|---|
| M0 | 冻结世界契约与核心存储 | 进行中 IN PROGRESS | 5/22 FINAL PASS + M0-006 R2 PATCH COMPLETE |
...
| M0-006 | ObjectRef / SourceRef 版本化引用、历史钉住与引用知识可见性 | R2 PATCH COMPLETE / WAITING CHIEF REVIEW | 181+15 | 待 | pinned vs floating, knowledge visibility, critical annotation exact, canary, DST R16/R17 |
