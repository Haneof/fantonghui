...
| ID 区间 | `COGN-DAY-2026-002001 ~ 003000`（与同目录《第一季 1000 题卷宗》的 001001~002000 不重叠） |
...
## 五、与同目录《第一季 1000 题卷宗》的并存关系

`benchmarks/cognitive_arena/` 下并存两套互不冲突的交付物：

| 交付物 | 形态 | ID 区间 | 题型配额 |
|---|---|---|---|
| 第一季 1000 题卷宗 | `papers/cognitive_exam_volume_1_1000.jsonl`（另有 splits / samples / reports） | `COGN-DAY-2026-001001 ~ 002000` | 380 / 270 / 250 / 100 |
| 本回执交付的题库 | `papers/exam_bank_1000/shard_01..10.json` + `index.json` | `COGN-DAY-2026-002001 ~ 003000` | 420 / 300 / 180 / 100 |

两者共用编号空间但区间互斥，可并行发放给不同模型做交叉做题。
