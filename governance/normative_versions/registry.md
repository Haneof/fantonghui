...
| POLICY-RUNTIME | `governance/runtime_policy.json` | 1.3.0 | `9d5ec331816149f93c9168272c7bec4894f6b4bb1a0ea2fc14a4212215ddf979` | **CURRENT**（1.3.0=合并两线后 M1-018 co_search 段回归入法；取代 1.2.0 行）；本轮与 arena 线合并后重算哈希（该线含 ADJ 判决集与 baseline 路径迁至 docs/ 的引用更新，参数未变） | CONST-v3.0.1 |
