"""VENDORED VERBATIM from arena/01a0aa2d-fantonghui src/aios_core/simulation/daily_summary_arena_protocol.py (official judge). EVAL-ONLY, never imported by solver.
