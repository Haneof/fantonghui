...
head_commit: 949e90e58bd073c1da5d23664bfcb1cb8154ebde
...
production_scope_detail: src/aios_core/contracts/models.py FROZEN, src/aios_core/storage/sqlite_store.py FROZEN, no production change from base 225eb76 to frozen 949e90e verified via git diff 225eb76..949e90e -- src/aios_core => empty
...
ci_python: 3.12.14
ci_tests: 253 passed
ci_detail: exact-head GitHub Actions SUCCESS Python 3.12.14 pytest 8.4.2 253 passed as recorded in governance/CONTROL_PANEL.md and governance/CURRENT_STATE.md
...
detailed_fixes:
  ...
  - ER18: real Entity A/B + Observation world1, EvidenceSet world2, Relation left A@1 right B@1 evidence [ES@1] then append floating revision None -> StoreError INVALID_ARGUMENT persistence_revalidation_failed, world rev 2, Relation NOT_FOUND
...
adversarial_validation:
  - A: Entity.object_type Literal -> ObjectType must fail ER19
  - B: Relation.object_type Literal -> ObjectType must fail ER19
  - C: old ER18 fake endpoints NOT_FOUND masking, fixed with real endpoints isolates floating evidence
  - D: remove durable revalidation -> fixed ER18 must FAIL (floating persisted)
...
compliance:
  - src/aios_core/** NOT MODIFIED in R1 (verified)
  - M0-011 NOT STARTED (chief-01 owned)
  - FINAL PASS history NOT MODIFIED
  - report written per AGENT_REPORT_PROTOCOL.md
